...
class Event(models.Model):
    ...
    start_date = models.DateTimeField(verbose_name=_("start date"), default="", blank=True)
    end_date = models.DateTimeField(_("end date"), default="", blank=True)

    start_onlydate = models.DateField(verbose_name=_("start date"), default=None)
    end_onlydate = models.DateField(_("end date"), default=None)

    start_onlytime = models.TimeField(verbose_name=_("start time"), default=None)
    end_onlytime = models.TimeField(_("end time"), default=None)
    ...
    phone = models.CharField(_('Phone'), max_length=12, default="")
    address_1 = models.CharField(_('Address 1'), max_length=100, default="")
    address_2 = models.CharField(_('Address 2'), max_length=100, blank=True, default="")
    city = models.CharField(_('City'), max_length=25, default="")
    state= models.CharField(_('State/Province'), max_length=25,default="")
    zipcode = models.CharField(_('ZIP/Postal Code'), max_length=10, default="")
    sales_order = models.CharField(_('Sales Order'), max_length=8, default="")
    pick = models.CharField(_('Pick List'), max_length=6, default="")
    weight = models.DecimalField(_('Total Weight'), max_digits=5, decimal_places=2, default = 0)
    pallet = models.IntegerField(_('Pallet Count'), default=0)
    driver = models.CharField(
        _("drivers"), max_length=15, choices=DRIVER_CHOICES, blank=True
    )
    ...
    created_by = models.ForeignKey(
        auth_user_model, verbose_name=_("created by"), related_name='events', default=0
    )
